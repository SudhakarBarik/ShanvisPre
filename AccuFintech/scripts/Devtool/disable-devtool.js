!(function (e, t) {
    ...
    function s(e, t) {
        var n,
            o = ("undefined" != typeof Symbol && e[Symbol.iterator]) || e["@@iterator"];
        if (!o) {
            if (
                Array.isArray(e) ||
                (o = (function (e, t) {
    ...
    var p = { iframe: !1, pc: !1, qqBrowser: !1, firefox: !1, macos: !1, edge: !1, oldEdge: !1, ie: !1, iosChrome: !1, iosEdge: !1, chrome: !1, seoBot: !1 };
    function U() {
        function e(e) {
        ...
        Object.assign(p, { iframe: n, pc: o, qqBrowser: i, firefox: r, macos: u, edge: c, oldEdge: a, ie: l, iosChrome: f, iosEdge: s, chrome: d, seoBot: v });
    }
    function H() {
        for (
            var e = (function () {
    ...
    function G(i) {
        ...
        W(e, t),
            ...
            void 0 !== (a = document).hidden
                ...
                : void 0 !== a.mozHidden
                ? ((r = "mozHidden"), (c = "mozvisibilitychange"), (u = "mozVisibilityState"))
                : void 0 !== a.msHidden
                ? ((r = "msHidden"), (c = "msvisibilitychange"), (u = "msVisibilityState"))
                : void 0 !== a.webkitHidden && ((r = "webkitHidden"), (c = "webkitvisibilitychange"), (u = "webkitVisibilityState")),
    ...
    function Q(e) {
        ...
        "function" == typeof b.ondevtoolclose && !0 === b.clearIntervalWhenDevOpenTrigger && ((b.clearIntervalWhenDevOpenTrigger = !1), console.warn("Test Tools"));
    }
    var w,
        g,
        Z,
    ...
    function O(n) {
        ...
        n.addEventListener(
            ...
            (e = n),
            b.disableMenu && D(e, "contextmenu"),
            (e = n),
            b.disableSelect && D(e, "selectstart"),
            (e = n),
            b.disableCopy && D(e, "copy"),
            (e = n),
            b.disableCut && D(e, "cut"),
            (e = n),
            b.disablePaste && D(e, "paste");
    }
    function D(t, e) {
            ...
            var t = (function (e, t) {
                    ...
                    for (var n = 1732584193, o = -271733879, i = -1732584194, r = 271733878, u = 0; u < e.length; u += 16) {
                        var c = n,
                            ...
                            l = i,
                            f = r;
                        (n = P(n, o, i, r, e[u + 0], 7, -680876936)),
                            (r = P(r, n, o, i, e[u + 1], 12, -389564586)),
                            (i = P(i, r, n, o, e[u + 2], 17, 606105819)),
                            (o = P(o, i, r, n, e[u + 3], 22, -1044525330)),
                            (n = P(n, o, i, r, e[u + 4], 7, -176418897)),
                            (r = P(r, n, o, i, e[u + 5], 12, 1200080426)),
                            (i = P(i, r, n, o, e[u + 6], 17, -1473231341)),
                            (o = P(o, i, r, n, e[u + 7], 22, -45705983)),
                            (n = P(n, o, i, r, e[u + 8], 7, 1770035416)),
                            (r = P(r, n, o, i, e[u + 9], 12, -1958414417)),
                            (i = P(i, r, n, o, e[u + 10], 17, -42063)),
                            (o = P(o, i, r, n, e[u + 11], 22, -1990404162)),
                            (n = P(n, o, i, r, e[u + 12], 7, 1804603682)),
                            (r = P(r, n, o, i, e[u + 13], 12, -40341101)),
                            (i = P(i, r, n, o, e[u + 14], 17, -1502002290)),
                            (o = P(o, i, r, n, e[u + 15], 22, 1236535329)),
                            (n = x(n, o, i, r, e[u + 1], 5, -165796510)),
                            (r = x(r, n, o, i, e[u + 6], 9, -1069501632)),
                            (i = x(i, r, n, o, e[u + 11], 14, 643717713)),
                            (o = x(o, i, r, n, e[u + 0], 20, -373897302)),
                            (n = x(n, o, i, r, e[u + 5], 5, -701558691)),
                            (r = x(r, n, o, i, e[u + 10], 9, 38016083)),
                            (i = x(i, r, n, o, e[u + 15], 14, -660478335)),
                            (o = x(o, i, r, n, e[u + 4], 20, -405537848)),
                            (n = x(n, o, i, r, e[u + 9], 5, 568446438)),
                            (r = x(r, n, o, i, e[u + 14], 9, -1019803690)),
                            (i = x(i, r, n, o, e[u + 3], 14, -187363961)),
                            (o = x(o, i, r, n, e[u + 8], 20, 1163531501)),
                            (n = x(n, o, i, r, e[u + 13], 5, -1444681467)),
                            (r = x(r, n, o, i, e[u + 2], 9, -51403784)),
                            (i = x(i, r, n, o, e[u + 7], 14, 1735328473)),
                            (o = x(o, i, r, n, e[u + 12], 20, -1926607734)),
                            ...
                            (n = I(n, o, i, r, e[u + 0], 6, -198630844)),
                            (r = I(r, n, o, i, e[u + 7], 10, 1126891415)),
                            (i = I(i, r, n, o, e[u + 14], 15, -1416354905)),
                            (o = I(o, i, r, n, e[u + 5], 21, -57434055)),
                            (n = I(n, o, i, r, e[u + 12], 6, 1700485571)),
                            (r = I(r, n, o, i, e[u + 3], 10, -1894986606)),
                            (i = I(i, r, n, o, e[u + 10], 15, -1051523)),
                            (o = I(o, i, r, n, e[u + 1], 21, -2054922799)),
                            (n = I(n, o, i, r, e[u + 8], 6, 1873313359)),
                            (r = I(r, n, o, i, e[u + 15], 10, -30611744)),
                            (i = I(i, r, n, o, e[u + 6], 15, -1560198380)),
                            (o = I(o, i, r, n, e[u + 13], 21, 1309151649)),
                            (n = I(n, o, i, r, e[u + 4], 6, -145523070)),
                            (r = I(r, n, o, i, e[u + 11], 10, -1120210379)),
                            (i = I(i, r, n, o, e[u + 2], 15, 718787259)),
                            (o = I(o, i, r, n, e[u + 9], 21, -343485551)),
                            (n = E(n, c)),
                            (o = E(o, a)),
                            (i = E(i, l)),
                            (r = E(r, f));
    ...
    ((C = _ = _ || {})[(C.Unknown = -1)] = "Unknown"),
        (C[(C.RegToString = 0)] = "RegToString"),
        (C[(C.DefineId = 1)] = "DefineId"),
        (C[(C.Size = 2)] = "Size"),
        (C[(C.DateToString = 3)] = "DateToString"),
        (C[(C.FuncToString = 4)] = "FuncToString"),
        (C[(C.Debugger = 5)] = "Debugger"),
        (C[(C.Performance = 6)] = "Performance"),
        (C[(C.DebugLib = 7)] = "DebugLib");
    var _,
        A = (function () {
            function n(e) {
                var t = e.type,
        ...
        C = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.RegToString, enabled: p.qqBrowser || p.firefox });
            }
            return (
                u(t, [
                    {
        ...
        oe = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.DefineId });
            }
            return (
                u(t, [
                    {
        ...
        ie = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.Size, enabled: !p.iframe && !p.edge });
            }
            return (
                u(t, [
                    {
    ...
    var R,
        ue = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.DateToString, enabled: !p.iosChrome });
            }
            return (
                u(t, [
                    {
        ...
        ce = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.FuncToString, enabled: !p.iosChrome && !p.iosEdge });
            }
            return (
                u(t, [
                    {
        ...
        ae = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.Debugger, enabled: p.iosChrome || p.iosEdge });
            }
            return (
                u(t, [
                    {
        ...
        le = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.Performance, enabled: p.chrome });
            }
            return (
                u(t, [
                    {
        ...
        fe = (function () {
            ...
            var e = l(t);
            function t() {
                return o(this, t), e.call(this, { type: _.DebugLib });
            }
            return (
                u(t, [
                    { key: "init", value: function () {} },
    ...
    var L = Object.assign(
        ...
        { isRunning: !1, isSuspend: !1, md5: ne, version: "0.3.3", DetectorType: _, isDevToolOpened: z }
    );
    C = (function () {
        ...
        var o = ["disable-menu", "disable-select", "disable-copy", "disable-cut", "disable-paste", "clear-log"],
            ...
            r = {};
        return (
            ["md5", "url", "tk-name", "detectors"].concat(o, i).forEach(function (e) {
                var t = n.getAttribute(e);
                null !== t &&
                    (-1 !== i.indexOf(e) ? (t = parseInt(t)) : -1 !== o.indexOf(e) ? (t = "false" !== t) : "detector" === e && "all" !== t && (t = t.split(" ")),
                    (r[
                        (function (e) {
